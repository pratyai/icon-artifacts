...
//            DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...

    {
        ...
        {
            double* in_arr = &__state->__0_gpu_vcflmax[(replaced_var_7 - 1)];
