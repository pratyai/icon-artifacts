...
inline void loop_body_7_0_36(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const float&  cfl_w_limit, const float&  dtime, float * __restrict__ gpu___CG_p_diag__m_w_concorr_c, float * __restrict__ gpu___CG_p_int__m_e_bln_c_s, float * __restrict__ gpu___CG_p_int__m_geofac_n2s, float * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, float * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, float * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, int* __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, float * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx_uint16, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16, float * __restrict__ gpu___CG_p_prog__m_w, float * __restrict__ gpu_z_v_grad_w, const float&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, float * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, float * __restrict__ gpu_maxvcfl_arr, float * __restrict__ gpu_vcflmax, float * __restrict__ gpu_z_ekinh, float * __restrict__ gpu_z_w_con_c, float * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...
inline void loop_body_70_0_36(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const float&  cfl_w_limit, const float&  dtime, float * __restrict__ gpu___CG_p_diag__m_w_concorr_c, float * __restrict__ gpu___CG_p_int__m_e_bln_c_s, float * __restrict__ gpu___CG_p_int__m_geofac_n2s, float * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, float * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, float * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, int* __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, float * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, int* __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int* __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, float * __restrict__ gpu___CG_p_prog__m_w, float * __restrict__ gpu_z_v_grad_w, const float&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, float * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, float * __restrict__ gpu_maxvcfl_arr, float * __restrict__ gpu_vcflmax, float * __restrict__ gpu_z_ekinh, float * __restrict__ gpu_z_w_con_c, float * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
    int i_startidx_in_var_79_1;
    int i_endidx_in_var_80_1;
    int i_startidx_in_var_79_0;
    int i_endidx_in_var_80_0;
...
//            DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...

    {
        ...
        {
            float* in_arr = &__state->__0_gpu_vcflmax[(replaced_var_5 - 1)];
