...
inline void loop_body_7_0_5(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, dace::float16 * __restrict__ gpu___CG_p_int__m_cells_aw_verts, uint16_t * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_w_v, int _for_it_0_0_0, int i_endblk_var_141_0, int i_endidx_in_var_143_0, int i_startblk_var_140_0, int i_startidx_in_var_142_0, int tmp_struct_symbol_6) {
...
inline void loop_body_7_0_13(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_verts__m_end_index, int* __restrict__ __CG_p_patch__CG_verts__m_start_index, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_rot, uint8_t * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_prog__m_vn, dace::float16 * __restrict__ gpu_zeta, int _for_it_3_0, int i_endblk_var_119_0, int i_startblk_var_118_0, int tmp_struct_symbol_8) {
...
inline void loop_body_7_0_41(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_edges__m_end_index, int* __restrict__ __CG_p_patch__CG_edges__m_start_index, dace::float16 * __restrict__ gpu___CG_p_diag__m_vn_ie, uint16_t * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, uint16_t * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_w_v, double* __restrict__ z_vt_ie, dace::float16 * __restrict__ gpu_z_v_grad_w, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int _for_it_16, int i_endblk_var_147, int replaced_var_0, int replaced_var_1, int tmp_struct_symbol_4, int tmp_struct_symbol_6) {
...
inline void loop_body_7_0_50(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const dace::float16&  cfl_w_limit, const dace::float16&  dtime, dace::float16 * __restrict__ gpu___CG_p_int__m_e_bln_c_s, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_n2s, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, dace::float16 * __restrict__ gpu___CG_p_metrics__m_wgtfac_c, int* __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, dace::float16 * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx_uint16, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_v_grad_w, const dace::float16&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, double* __restrict__ z_w_concorr_me, dace::float16 * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, dace::float16 * __restrict__ gpu___CG_p_diag__m_w_concorr_c, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, dace::float16 * __restrict__ gpu_maxvcfl_arr, dace::float16 * __restrict__ gpu_vcflmax, dace::float16 * __restrict__ gpu_z_ekinh, dace::float16 * __restrict__ gpu_z_w_con_c, dace::float16 * __restrict__ gpu_z_w_con_c_full, dace::float16 * __restrict__ gpu_z_w_concorr_mc, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

    {
        ...
        {
            dace::float16* _out = gpu_z_w_con_c + ((i_startidx_var_148 + (90 * tmp_struct_symbol_1)) - 1);

            ///////////////////
            int __dace_current_stream_id = 0;
            cudaStream_t __dace_current_stream = __state->gpu_context->streams[__dace_current_stream_id];
            cudaMemsetAsync(_out, 0, ((i_endidx_var_149 - i_startidx_var_148) + 1) * sizeof(dace::float16), nullptr);
            ///////////////////
...

    {
        ...
        {
            dace::float16 * in_arr = &gpu_maxvcfl_arr[((i_startidx_var_148 + ((88 * tmp_struct_symbol_4) * (_for_it_22 - 1))) - 1)];
...
inline void loop_body_7_0_88(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_edges__m_end_index, int* __restrict__ __CG_p_patch__CG_edges__m_start_index, const dace::float16&  cfl_w_limit, const dace::float16&  dtime, dace::float16 * __restrict__ gpu___CG_p_diag__m_vn_ie, dace::float16 * __restrict__ gpu___CG_p_diag__m_vt, dace::float16 * __restrict__ gpu___CG_p_int__m_c_lin_e, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_grdiv, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge, uint16_t * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, uint8_t * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, uint16_t * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx_uint16, dace::float16 * __restrict__ gpu___CG_p_prog__m_vn, uint8_t * __restrict__ gpu_levelmask, dace::float16 * __restrict__ gpu_z_ekinh, dace::float16 * __restrict__ gpu_z_w_con_c_full, dace::float16 * __restrict__ gpu_zeta, const dace::float16&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, dace::float16 * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_47, int i_endblk_var_147, int nrdmax_jg, int ntnd, int replaced_var_4, int replaced_var_5, int tmp_struct_symbol_10, int tmp_struct_symbol_2, int tmp_struct_symbol_8) {
...
inline void loop_body_78_0_5(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, dace::float16 * __restrict__ gpu___CG_p_int__m_cells_aw_verts, int* __restrict__ gpu___CG_p_patch__CG_verts__m_cell_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_w_v, int _for_it_0_0_0, int i_endblk_var_141_0, int i_endidx_in_var_143_0, int i_startblk_var_140_0, int i_startidx_in_var_142_0, int tmp_struct_symbol_6) {
    int i_startidx_var_46_0_0;
    int i_endidx_var_47_0_0;
...
inline void loop_body_78_0_13(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_verts__m_end_index, int* __restrict__ __CG_p_patch__CG_verts__m_start_index, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_rot, uint8_t * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk_uint8, int* __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_vn, dace::float16 * __restrict__ gpu_zeta, int _for_it_3_0, int i_endblk_var_119_0, int i_startblk_var_118_0, int tmp_struct_symbol_8) {
    int i_startidx_in_var_103_0_0;
    int i_endidx_in_var_104_0_0;
    int i_startidx_var_120_0;
    int i_endidx_var_121_0;
...
inline void loop_body_78_0_23(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_edges__m_end_index, int* __restrict__ __CG_p_patch__CG_edges__m_start_index, dace::float16 * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddxn_z_full, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddxt_z_full, dace::float16 * __restrict__ gpu___CG_p_metrics__m_wgtfac_e, dace::float16 * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e, uint8_t * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk_uint8, int* __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_vn, dace::float16 * __restrict__ gpu___CG_p_diag__m_vn_ie, dace::float16 * __restrict__ gpu___CG_p_diag__m_vt, double* __restrict__ z_kin_hor_e, double* __restrict__ z_vt_ie, double* __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, int _for_it_6, int i_endblk_var_147, int i_startblk_var_146, int nflatlev_jg) {
    int i_startidx_in_var_91_3;
    int i_endidx_in_var_92_3;
    int i_startidx_var_148;
    int i_endidx_var_149;
...
inline void loop_body_78_0_41(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_edges__m_end_index, int* __restrict__ __CG_p_patch__CG_edges__m_start_index, dace::float16 * __restrict__ gpu___CG_p_diag__m_vn_ie, int* __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, int* __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_w_v, double* __restrict__ z_vt_ie, dace::float16 * __restrict__ gpu_z_v_grad_w, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int _for_it_16, int i_endblk_var_147, int replaced_var_0, int replaced_var_1, int tmp_struct_symbol_4, int tmp_struct_symbol_6) {
    int i_startidx_in_var_91_2;
    int i_endidx_in_var_92_2;
    int i_startidx_var_148;
    int i_endidx_var_149;
...
inline void loop_body_78_0_50(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const dace::float16&  cfl_w_limit, const dace::float16&  dtime, dace::float16 * __restrict__ gpu___CG_p_int__m_e_bln_c_s, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_n2s, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, dace::float16 * __restrict__ gpu___CG_p_metrics__m_wgtfac_c, int* __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, dace::float16 * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, int* __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int* __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_w, dace::float16 * __restrict__ gpu_z_v_grad_w, const dace::float16&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, double* __restrict__ z_w_concorr_me, dace::float16 * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, dace::float16 * __restrict__ gpu___CG_p_diag__m_w_concorr_c, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, dace::float16 * __restrict__ gpu_maxvcfl_arr, dace::float16 * __restrict__ gpu_vcflmax, dace::float16 * __restrict__ gpu_z_ekinh, dace::float16 * __restrict__ gpu_z_w_con_c, dace::float16 * __restrict__ gpu_z_w_con_c_full, dace::float16 * __restrict__ gpu_z_w_concorr_mc, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
    int i_startidx_in_var_79_1;
    int i_endidx_in_var_80_1;
    int i_startidx_in_var_79_0;
    int i_endidx_in_var_80_0;
...
inline void loop_body_78_0_88(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_edges__m_end_index, int* __restrict__ __CG_p_patch__CG_edges__m_start_index, const dace::float16&  cfl_w_limit, const dace::float16&  dtime, dace::float16 * __restrict__ gpu___CG_p_diag__m_vn_ie, dace::float16 * __restrict__ gpu___CG_p_diag__m_vt, dace::float16 * __restrict__ gpu___CG_p_int__m_c_lin_e, dace::float16 * __restrict__ gpu___CG_p_int__m_geofac_grdiv, dace::float16 * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin, dace::float16 * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge, int* __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, uint8_t * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk_uint8, int* __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, dace::float16 * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, int* __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, dace::float16 * __restrict__ gpu___CG_p_prog__m_vn, uint8_t * __restrict__ gpu_levelmask, dace::float16 * __restrict__ gpu_z_ekinh, dace::float16 * __restrict__ gpu_z_w_con_c_full, dace::float16 * __restrict__ gpu_zeta, const dace::float16&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, dace::float16 * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_47, int i_endblk_var_147, int nrdmax_jg, int ntnd, int replaced_var_4, int replaced_var_5, int tmp_struct_symbol_10, int tmp_struct_symbol_2, int tmp_struct_symbol_8) {
    int i_startidx_in_var_91_0;
    int i_endidx_in_var_92_0;
    int i_startidx_var_148;
    int i_endidx_var_149;
...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t*__state, int * __restrict__ __CG_global_data__m_nflatlev, int * __restrict__ __CG_global_data__m_nrdmax, int * __restrict__ __CG_p_patch__CG_cells__m_end_block, int * __restrict__ __CG_p_patch__CG_cells__m_end_index, int * __restrict__ __CG_p_patch__CG_cells__m_start_block, int * __restrict__ __CG_p_patch__CG_cells__m_start_index, int * __restrict__ __CG_p_patch__CG_edges__m_end_block, int * __restrict__ __CG_p_patch__CG_edges__m_end_index, int * __restrict__ __CG_p_patch__CG_edges__m_start_block, int * __restrict__ __CG_p_patch__CG_edges__m_start_index, int * __restrict__ __CG_p_patch__CG_verts__m_end_block, int * __restrict__ __CG_p_patch__CG_verts__m_end_index, int * __restrict__ __CG_p_patch__CG_verts__m_start_block, int * __restrict__ __CG_p_patch__CG_verts__m_start_index, global_data_type* global_data, double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_vn_ie_fp64, double * __restrict__ gpu___CG_p_diag__m_vt_fp64, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c_fp64, double * __restrict__ gpu___CG_p_int__m_c_lin_e_fp64, double * __restrict__ gpu___CG_p_int__m_cells_aw_verts_fp64, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_grdiv_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_n2s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_rot_fp64, double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxn_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxt_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_c_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double * __restrict__ gpu___CG_p_patch__CG_cells__m_area_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx, double * __restrict__ gpu___CG_p_prog__m_vn_fp64, double * __restrict__ gpu___CG_p_prog__m_w_fp64, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __CG_global_data__m_nproma, double& __CG_p_diag__m_max_vcfl_dyn, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double __abi_dt_linintp_ubc, double __abi_dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
  ...
  dace::float16 dt_linintp_ubc = static_cast<dace::float16>(__abi_dt_linintp_ubc);
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_diag__m_ddt_vn_apc_pc, (((((90 * __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9) * __f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9) * (__f2dace_SA_ddt_vn_apc_pc_d_3_s_p_diag_9 - 1)) + ((90 * __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9) * (__f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9 - 1))) + (90 * __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9)) * sizeof(dace::float16)));
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_diag__m_vn_ie, (((91 * __f2dace_SA_vn_ie_d_0_s_p_diag_9) * (__f2dace_SA_vn_ie_d_2_s_p_diag_9 - 1)) + (91 * __f2dace_SA_vn_ie_d_0_s_p_diag_9)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_diag__m_vt;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_diag__m_vt, (((90 * __f2dace_SA_vt_d_0_s_p_diag_9) * (__f2dace_SA_vt_d_2_s_p_diag_9 - 1)) + (90 * __f2dace_SA_vt_d_0_s_p_diag_9)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_diag__m_w_concorr_c;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_diag__m_w_concorr_c, (((91 * __f2dace_SA_w_concorr_c_d_0_s_p_diag_9) * (__f2dace_SA_w_concorr_c_d_2_s_p_diag_9 - 1)) + (91 * __f2dace_SA_w_concorr_c_d_0_s_p_diag_9)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_int__m_c_lin_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_c_lin_e, ((((__f2dace_SA_c_lin_e_d_0_s_p_int_6 * __f2dace_SA_c_lin_e_d_1_s_p_int_6) * (__f2dace_SA_c_lin_e_d_2_s_p_int_6 - 1)) + (__f2dace_SA_c_lin_e_d_0_s_p_int_6 * (__f2dace_SA_c_lin_e_d_1_s_p_int_6 - 1))) + __f2dace_SA_c_lin_e_d_0_s_p_int_6) * sizeof(dace::float16)));
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_e_bln_c_s, ((((__f2dace_SA_e_bln_c_s_d_0_s_p_int_6 * __f2dace_SA_e_bln_c_s_d_1_s_p_int_6) * (__f2dace_SA_e_bln_c_s_d_2_s_p_int_6 - 1)) + (__f2dace_SA_e_bln_c_s_d_0_s_p_int_6 * (__f2dace_SA_e_bln_c_s_d_1_s_p_int_6 - 1))) + __f2dace_SA_e_bln_c_s_d_0_s_p_int_6) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_int__m_geofac_grdiv;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_geofac_grdiv, ((((__f2dace_SA_geofac_grdiv_d_0_s_p_int_6 * __f2dace_SA_geofac_grdiv_d_1_s_p_int_6) * (__f2dace_SA_geofac_grdiv_d_2_s_p_int_6 - 1)) + (__f2dace_SA_geofac_grdiv_d_0_s_p_int_6 * (__f2dace_SA_geofac_grdiv_d_1_s_p_int_6 - 1))) + __f2dace_SA_geofac_grdiv_d_0_s_p_int_6) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_int__m_geofac_n2s;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_geofac_n2s, ((((__f2dace_SA_geofac_n2s_d_0_s_p_int_6 * __f2dace_SA_geofac_n2s_d_1_s_p_int_6) * (__f2dace_SA_geofac_n2s_d_2_s_p_int_6 - 1)) + (__f2dace_SA_geofac_n2s_d_0_s_p_int_6 * (__f2dace_SA_geofac_n2s_d_1_s_p_int_6 - 1))) + __f2dace_SA_geofac_n2s_d_0_s_p_int_6) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_int__m_geofac_rot;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_geofac_rot, ((((__f2dace_SA_geofac_rot_d_0_s_p_int_6 * __f2dace_SA_geofac_rot_d_1_s_p_int_6) * (__f2dace_SA_geofac_rot_d_2_s_p_int_6 - 1)) + (__f2dace_SA_geofac_rot_d_0_s_p_int_6 * (__f2dace_SA_geofac_rot_d_1_s_p_int_6 - 1))) + __f2dace_SA_geofac_rot_d_0_s_p_int_6) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_int__m_rbf_vec_coeff_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_rbf_vec_coeff_e, ((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * (__f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6 - 1)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * (__f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6 - 1))) + __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_coeff1_dwdz;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_coeff1_dwdz, (((90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8) * (__f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_coeff2_dwdz;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_coeff2_dwdz, (((90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8) * (__f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddqz_z_full_e, (((90 * __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8) * (__f2dace_SA_ddqz_z_full_e_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_ddqz_z_half;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddqz_z_half, (((91 * __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8) * (__f2dace_SA_ddqz_z_half_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_ddxn_z_full;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddxn_z_full, (((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_ddxt_z_full;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddxt_z_full, (((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_wgtfac_c;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfac_c, (((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_c_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_wgtfac_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfac_e, (((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_e_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_metrics__m_wgtfacq_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfacq_e, ((((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * (__f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8 - 1)) + (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * (__f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8 - 1))) + __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_cells__m_area;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_cells__m_area, ((__f2dace_SA_area_d_0_s_cells_p_patch_2 * (__f2dace_SA_area_d_1_s_cells_p_patch_2 - 1)) + __f2dace_SA_area_d_0_s_cells_p_patch_2) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_edges__m_area_edge;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_edges__m_area_edge, ((__f2dace_SA_area_edge_d_0_s_edges_p_patch_4 * (__f2dace_SA_area_edge_d_1_s_edges_p_patch_4 - 1)) + __f2dace_SA_area_edge_d_0_s_edges_p_patch_4) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_edges__m_f_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_edges__m_f_e, ((__f2dace_SA_f_e_d_0_s_edges_p_patch_4 * (__f2dace_SA_f_e_d_1_s_edges_p_patch_4 - 1)) + __f2dace_SA_f_e_d_0_s_edges_p_patch_4) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, ((__f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4 * (__f2dace_SA_inv_dual_edge_length_d_1_s_edges_p_patch_4 - 1)) + __f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, ((__f2dace_SA_inv_primal_edge_length_d_0_s_edges_p_patch_4 * (__f2dace_SA_inv_primal_edge_length_d_1_s_edges_p_patch_4 - 1)) + __f2dace_SA_inv_primal_edge_length_d_0_s_edges_p_patch_4) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_patch__CG_edges__m_tangent_orientation;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_patch__CG_edges__m_tangent_orientation, ((__f2dace_SA_tangent_orientation_d_0_s_edges_p_patch_4 * (__f2dace_SA_tangent_orientation_d_1_s_edges_p_patch_4 - 1)) + __f2dace_SA_tangent_orientation_d_0_s_edges_p_patch_4) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_prog__m_vn;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_prog__m_vn, (((90 * __f2dace_SA_vn_d_0_s_p_prog_7) * (__f2dace_SA_vn_d_2_s_p_prog_7 - 1)) + (90 * __f2dace_SA_vn_d_0_s_p_prog_7)) * sizeof(dace::float16)));
    dace::float16 * gpu___CG_p_prog__m_w;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_prog__m_w, (((91 * __f2dace_SA_w_d_0_s_p_prog_7) * (__f2dace_SA_w_d_2_s_p_prog_7 - 1)) + (91 * __f2dace_SA_w_d_0_s_p_prog_7)) * sizeof(dace::float16)));
    int nrdmax_jg;
    int nflatlev_jg;
...

    {
        ...
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_cells__m_area_fp64_0_0_0_5_3(__state, gpu___CG_p_patch__CG_cells__m_area, gpu___CG_p_patch__CG_cells__m_area_fp64, __f2dace_SA_area_d_0_s_cells_p_patch_2, __f2dace_SA_area_d_1_s_cells_p_patch_2);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64_0_0_0_5_8(__state, gpu___CG_p_patch__CG_edges__m_tangent_orientation, gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64, __f2dace_SA_tangent_orientation_d_0_s_edges_p_patch_4, __f2dace_SA_tangent_orientation_d_1_s_edges_p_patch_4);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64_0_0_0_5_13(__state, gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64, __f2dace_SA_inv_primal_edge_length_d_0_s_edges_p_patch_4, __f2dace_SA_inv_primal_edge_length_d_1_s_edges_p_patch_4);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64_0_0_0_5_18(__state, gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64, __f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4, __f2dace_SA_inv_dual_edge_length_d_1_s_edges_p_patch_4);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_edges__m_area_edge_fp64_0_0_0_5_23(__state, gpu___CG_p_patch__CG_edges__m_area_edge, gpu___CG_p_patch__CG_edges__m_area_edge_fp64, __f2dace_SA_area_edge_d_0_s_edges_p_patch_4, __f2dace_SA_area_edge_d_1_s_edges_p_patch_4);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_patch__CG_edges__m_f_e_fp64_0_0_0_5_28(__state, gpu___CG_p_patch__CG_edges__m_f_e, gpu___CG_p_patch__CG_edges__m_f_e_fp64, __f2dace_SA_f_e_d_0_s_edges_p_patch_4, __f2dace_SA_f_e_d_1_s_edges_p_patch_4);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_c_lin_e_fp64_0_0_0_5_33(__state, gpu___CG_p_int__m_c_lin_e, gpu___CG_p_int__m_c_lin_e_fp64, __f2dace_SA_c_lin_e_d_0_s_p_int_6, __f2dace_SA_c_lin_e_d_1_s_p_int_6, __f2dace_SA_c_lin_e_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_e_bln_c_s_fp64_0_0_0_5_38(__state, gpu___CG_p_int__m_e_bln_c_s, gpu___CG_p_int__m_e_bln_c_s_fp64, __f2dace_SA_e_bln_c_s_d_0_s_p_int_6, __f2dace_SA_e_bln_c_s_d_1_s_p_int_6, __f2dace_SA_e_bln_c_s_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_cells_aw_verts_fp64_0_0_0_5_43(__state, gpu___CG_p_int__m_cells_aw_verts, gpu___CG_p_int__m_cells_aw_verts_fp64, __f2dace_SA_cells_aw_verts_d_0_s_p_int_6, __f2dace_SA_cells_aw_verts_d_1_s_p_int_6, __f2dace_SA_cells_aw_verts_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_rbf_vec_coeff_e_fp64_0_0_0_5_48(__state, gpu___CG_p_int__m_rbf_vec_coeff_e, gpu___CG_p_int__m_rbf_vec_coeff_e_fp64, __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6, __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6, __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_geofac_grdiv_fp64_0_0_0_5_53(__state, gpu___CG_p_int__m_geofac_grdiv, gpu___CG_p_int__m_geofac_grdiv_fp64, __f2dace_SA_geofac_grdiv_d_0_s_p_int_6, __f2dace_SA_geofac_grdiv_d_1_s_p_int_6, __f2dace_SA_geofac_grdiv_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_geofac_rot_fp64_0_0_0_5_58(__state, gpu___CG_p_int__m_geofac_rot, gpu___CG_p_int__m_geofac_rot_fp64, __f2dace_SA_geofac_rot_d_0_s_p_int_6, __f2dace_SA_geofac_rot_d_1_s_p_int_6, __f2dace_SA_geofac_rot_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_int__m_geofac_n2s_fp64_0_0_0_5_63(__state, gpu___CG_p_int__m_geofac_n2s, gpu___CG_p_int__m_geofac_n2s_fp64, __f2dace_SA_geofac_n2s_d_0_s_p_int_6, __f2dace_SA_geofac_n2s_d_1_s_p_int_6, __f2dace_SA_geofac_n2s_d_2_s_p_int_6);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_prog__m_w_fp64_0_0_0_5_68(__state, gpu___CG_p_prog__m_w, gpu___CG_p_prog__m_w_fp64, __f2dace_SA_w_d_0_s_p_prog_7, __f2dace_SA_w_d_2_s_p_prog_7);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_prog__m_vn_fp64_0_0_0_5_73(__state, gpu___CG_p_prog__m_vn, gpu___CG_p_prog__m_vn_fp64, __f2dace_SA_vn_d_0_s_p_prog_7, __f2dace_SA_vn_d_2_s_p_prog_7);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_ddxn_z_full_fp64_0_0_0_5_78(__state, gpu___CG_p_metrics__m_ddxn_z_full, gpu___CG_p_metrics__m_ddxn_z_full_fp64, __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8, __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_ddxt_z_full_fp64_0_0_0_5_83(__state, gpu___CG_p_metrics__m_ddxt_z_full, gpu___CG_p_metrics__m_ddxt_z_full_fp64, __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8, __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_ddqz_z_full_e_fp64_0_0_0_5_88(__state, gpu___CG_p_metrics__m_ddqz_z_full_e, gpu___CG_p_metrics__m_ddqz_z_full_e_fp64, __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_full_e_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_ddqz_z_half_fp64_0_0_0_5_93(__state, gpu___CG_p_metrics__m_ddqz_z_half, gpu___CG_p_metrics__m_ddqz_z_half_fp64, __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_half_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_wgtfac_c_fp64_0_0_0_5_98(__state, gpu___CG_p_metrics__m_wgtfac_c, gpu___CG_p_metrics__m_wgtfac_c_fp64, __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8, __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_wgtfac_e_fp64_0_0_0_5_103(__state, gpu___CG_p_metrics__m_wgtfac_e, gpu___CG_p_metrics__m_wgtfac_e_fp64, __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8, __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_wgtfacq_e_fp64_0_0_0_5_108(__state, gpu___CG_p_metrics__m_wgtfacq_e, gpu___CG_p_metrics__m_wgtfacq_e_fp64, __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8, __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8, __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_coeff_gradekin_fp64_0_0_0_5_113(__state, gpu___CG_p_metrics__m_coeff_gradekin, gpu___CG_p_metrics__m_coeff_gradekin_fp64, __f2dace_SA_coeff_gradekin_d_0_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_1_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_coeff1_dwdz_fp64_0_0_0_5_118(__state, gpu___CG_p_metrics__m_coeff1_dwdz, gpu___CG_p_metrics__m_coeff1_dwdz_fp64, __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_metrics__m_coeff2_dwdz_fp64_0_0_0_5_123(__state, gpu___CG_p_metrics__m_coeff2_dwdz, gpu___CG_p_metrics__m_coeff2_dwdz_fp64, __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_diag__m_vt_fp64_0_0_0_5_128(__state, gpu___CG_p_diag__m_vt, gpu___CG_p_diag__m_vt_fp64, __f2dace_SA_vt_d_0_s_p_diag_9, __f2dace_SA_vt_d_2_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_diag__m_vn_ie_fp64_0_0_0_5_133(__state, gpu___CG_p_diag__m_vn_ie, gpu___CG_p_diag__m_vn_ie_fp64, __f2dace_SA_vn_ie_d_0_s_p_diag_9, __f2dace_SA_vn_ie_d_2_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_h2d_gpu___CG_p_diag__m_w_concorr_c_fp64_0_0_0_5_138(__state, gpu___CG_p_diag__m_w_concorr_c, gpu___CG_p_diag__m_w_concorr_c_fp64, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SA_w_concorr_c_d_2_s_p_diag_9);
//        DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
    ...
    if ((bitwidth_sym == 16)) {
        {
            ...
            DACE_GPU_CHECK(cudaMemcpyAsync(__state->__0_vcflmax, __state->__0_gpu_vcflmax, tmp_struct_symbol_12 * sizeof(dace::float16), cudaMemcpyDeviceToHost, nullptr));
...
//            DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...

    {
        ...
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_prog__m_w_0_0_0_6_3(__state, gpu___CG_p_prog__m_w, gpu___CG_p_prog__m_w_fp64, __f2dace_SA_w_d_0_s_p_prog_7, __f2dace_SA_w_d_2_s_p_prog_7);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_prog__m_vn_0_0_0_6_8(__state, gpu___CG_p_prog__m_vn, gpu___CG_p_prog__m_vn_fp64, __f2dace_SA_vn_d_0_s_p_prog_7, __f2dace_SA_vn_d_2_s_p_prog_7);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_diag__m_vt_0_0_0_6_13(__state, gpu___CG_p_diag__m_vt, gpu___CG_p_diag__m_vt_fp64, __f2dace_SA_vt_d_0_s_p_diag_9, __f2dace_SA_vt_d_2_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_diag__m_vn_ie_0_0_0_6_18(__state, gpu___CG_p_diag__m_vn_ie, gpu___CG_p_diag__m_vn_ie_fp64, __f2dace_SA_vn_ie_d_0_s_p_diag_9, __f2dace_SA_vn_ie_d_2_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_diag__m_w_concorr_c_0_0_0_6_23(__state, gpu___CG_p_diag__m_w_concorr_c, gpu___CG_p_diag__m_w_concorr_c_fp64, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SA_w_concorr_c_d_2_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_diag__m_ddt_vn_apc_pc_0_0_0_6_28(__state, gpu___CG_p_diag__m_ddt_vn_apc_pc, gpu___CG_p_diag__m_ddt_vn_apc_pc_fp64, __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_3_s_p_diag_9);
        __dace_runkernel_boundary_cast_gpu_d2h_gpu___CG_p_diag__m_ddt_w_adv_pc_0_0_0_6_33(__state, gpu___CG_p_diag__m_ddt_w_adv_pc, gpu___CG_p_diag__m_ddt_w_adv_pc_fp64, __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9);
//        DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...
DACE_EXPORTED void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, int * __restrict__ __CG_global_data__m_nflatlev, int * __restrict__ __CG_global_data__m_nrdmax, int * __restrict__ __CG_p_patch__CG_cells__m_end_block, int * __restrict__ __CG_p_patch__CG_cells__m_end_index, int * __restrict__ __CG_p_patch__CG_cells__m_start_block, int * __restrict__ __CG_p_patch__CG_cells__m_start_index, int * __restrict__ __CG_p_patch__CG_edges__m_end_block, int * __restrict__ __CG_p_patch__CG_edges__m_end_index, int * __restrict__ __CG_p_patch__CG_edges__m_start_block, int * __restrict__ __CG_p_patch__CG_edges__m_start_index, int * __restrict__ __CG_p_patch__CG_verts__m_end_block, int * __restrict__ __CG_p_patch__CG_verts__m_end_index, int * __restrict__ __CG_p_patch__CG_verts__m_start_block, int * __restrict__ __CG_p_patch__CG_verts__m_start_index, global_data_type* global_data, double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_vn_ie_fp64, double * __restrict__ gpu___CG_p_diag__m_vt_fp64, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c_fp64, double * __restrict__ gpu___CG_p_int__m_c_lin_e_fp64, double * __restrict__ gpu___CG_p_int__m_cells_aw_verts_fp64, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_grdiv_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_n2s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_rot_fp64, double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxn_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxt_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_c_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double * __restrict__ gpu___CG_p_patch__CG_cells__m_area_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx, double * __restrict__ gpu___CG_p_prog__m_vn_fp64, double * __restrict__ gpu___CG_p_prog__m_w_fp64, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __CG_global_data__m_nproma, double& __CG_p_diag__m_max_vcfl_dyn, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double __abi_dt_linintp_ubc, double __abi_dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
  dace::float16 dtime = static_cast<dace::float16>(__abi_dtime);
  dace::float16 dt_linintp_ubc = static_cast<dace::float16>(__abi_dt_linintp_ubc);
    __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(__state, __CG_global_data__m_nflatlev, __CG_global_data__m_nrdmax, __CG_p_patch__CG_cells__m_end_block, __CG_p_patch__CG_cells__m_end_index, __CG_p_patch__CG_cells__m_start_block, __CG_p_patch__CG_cells__m_start_index, __CG_p_patch__CG_edges__m_end_block, __CG_p_patch__CG_edges__m_end_index, __CG_p_patch__CG_edges__m_start_block, __CG_p_patch__CG_edges__m_start_index, __CG_p_patch__CG_verts__m_end_block, __CG_p_patch__CG_verts__m_end_index, __CG_p_patch__CG_verts__m_start_block, __CG_p_patch__CG_verts__m_start_index, global_data, gpu___CG_p_diag__m_ddt_vn_apc_pc_fp64, gpu___CG_p_diag__m_ddt_w_adv_pc_fp64, gpu___CG_p_diag__m_vn_ie_fp64, gpu___CG_p_diag__m_vt_fp64, gpu___CG_p_diag__m_w_concorr_c_fp64, gpu___CG_p_int__m_c_lin_e_fp64, gpu___CG_p_int__m_cells_aw_verts_fp64, gpu___CG_p_int__m_e_bln_c_s_fp64, gpu___CG_p_int__m_geofac_grdiv_fp64, gpu___CG_p_int__m_geofac_n2s_fp64, gpu___CG_p_int__m_geofac_rot_fp64, gpu___CG_p_int__m_rbf_vec_coeff_e_fp64, gpu___CG_p_metrics__m_coeff1_dwdz_fp64, gpu___CG_p_metrics__m_coeff2_dwdz_fp64, gpu___CG_p_metrics__m_coeff_gradekin_fp64, gpu___CG_p_metrics__m_ddqz_z_full_e_fp64, gpu___CG_p_metrics__m_ddqz_z_half_fp64, gpu___CG_p_metrics__m_ddxn_z_full_fp64, gpu___CG_p_metrics__m_ddxt_z_full_fp64, gpu___CG_p_metrics__m_wgtfac_c_fp64, gpu___CG_p_metrics__m_wgtfac_e_fp64, gpu___CG_p_metrics__m_wgtfacq_e_fp64, gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, gpu___CG_p_patch__CG_cells__m_area_fp64, gpu___CG_p_patch__CG_cells__m_edge_blk, gpu___CG_p_patch__CG_cells__m_edge_idx, gpu___CG_p_patch__CG_cells__m_neighbor_blk, gpu___CG_p_patch__CG_cells__m_neighbor_idx, gpu___CG_p_patch__CG_edges__m_area_edge_fp64, gpu___CG_p_patch__CG_edges__m_cell_blk, gpu___CG_p_patch__CG_edges__m_cell_idx, gpu___CG_p_patch__CG_edges__m_f_e_fp64, gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64, gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64, gpu___CG_p_patch__CG_edges__m_quad_blk, gpu___CG_p_patch__CG_edges__m_quad_idx, gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64, gpu___CG_p_patch__CG_edges__m_vertex_blk, gpu___CG_p_patch__CG_edges__m_vertex_idx, gpu___CG_p_patch__CG_verts__m_cell_blk, gpu___CG_p_patch__CG_verts__m_cell_idx, gpu___CG_p_patch__CG_verts__m_edge_blk, gpu___CG_p_patch__CG_verts__m_edge_idx, gpu___CG_p_prog__m_vn_fp64, gpu___CG_p_prog__m_w_fp64, p_diag, p_int, p_metrics, p_patch, p_prog, z_kin_hor_e, z_vt_ie, z_w_concorr_me, __CG_global_data__m_nproma, __CG_p_diag__m_max_vcfl_dyn, __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_A_z_w_concorr_me_d_0_s, __f2dace_A_z_w_concorr_me_d_1_s, __f2dace_OA_z_kin_hor_e_d_0_s, __f2dace_OA_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_2_s, __f2dace_OA_z_vt_ie_d_0_s, __f2dace_OA_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_2_s, __f2dace_OA_z_w_concorr_me_d_0_s, __f2dace_OA_z_w_concorr_me_d_1_s, __f2dace_OA_z_w_concorr_me_d_2_s, dt_linintp_ubc, dtime, istep, ldeepatmo, lvn_only, ntnd);
}
...
DACE_EXPORTED velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1(int * __restrict__ __CG_global_data__m_nflatlev, int * __restrict__ __CG_global_data__m_nrdmax, int * __restrict__ __CG_p_patch__CG_cells__m_end_block, int * __restrict__ __CG_p_patch__CG_cells__m_end_index, int * __restrict__ __CG_p_patch__CG_cells__m_start_block, int * __restrict__ __CG_p_patch__CG_cells__m_start_index, int * __restrict__ __CG_p_patch__CG_edges__m_end_block, int * __restrict__ __CG_p_patch__CG_edges__m_end_index, int * __restrict__ __CG_p_patch__CG_edges__m_start_block, int * __restrict__ __CG_p_patch__CG_edges__m_start_index, int * __restrict__ __CG_p_patch__CG_verts__m_end_block, int * __restrict__ __CG_p_patch__CG_verts__m_end_index, int * __restrict__ __CG_p_patch__CG_verts__m_start_block, int * __restrict__ __CG_p_patch__CG_verts__m_start_index, global_data_type* global_data, double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc_fp64, double * __restrict__ gpu___CG_p_diag__m_vn_ie_fp64, double * __restrict__ gpu___CG_p_diag__m_vt_fp64, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c_fp64, double * __restrict__ gpu___CG_p_int__m_c_lin_e_fp64, double * __restrict__ gpu___CG_p_int__m_cells_aw_verts_fp64, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_grdiv_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_n2s_fp64, double * __restrict__ gpu___CG_p_int__m_geofac_rot_fp64, double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz_fp64, double * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxn_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_ddxt_z_full_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_c_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_e_fp64, double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double * __restrict__ gpu___CG_p_patch__CG_cells__m_area_fp64, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_blk, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length_fp64, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation_fp64, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_cell_idx, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk, int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx, double * __restrict__ gpu___CG_p_prog__m_vn_fp64, double * __restrict__ gpu___CG_p_prog__m_w_fp64, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __CG_global_data__m_nproma, double& __CG_p_diag__m_max_vcfl_dyn, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double __abi_dt_linintp_ubc, double __abi_dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
  ...
  __result |= __dace_init_cuda_0(
      __state, __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_A_z_w_concorr_me_d_0_s, __f2dace_A_z_w_concorr_me_d_1_s, __f2dace_OA_z_kin_hor_e_d_0_s, __f2dace_OA_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_2_s, __f2dace_OA_z_vt_ie_d_0_s, __f2dace_OA_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_2_s, __f2dace_OA_z_w_concorr_me_d_0_s, __f2dace_OA_z_w_concorr_me_d_1_s, __f2dace_OA_z_w_concorr_me_d_2_s, __f2dace_SA_area_d_0_s_cells_p_patch_2, __f2dace_SA_area_d_1_s_cells_p_patch_2, __f2dace_SA_area_edge_d_0_s_edges_p_patch_4, __f2dace_SA_area_edge_d_1_s_edges_p_patch_4, __f2dace_SA_c_lin_e_d_0_s_p_int_6, __f2dace_SA_c_lin_e_d_1_s_p_int_6, __f2dace_SA_c_lin_e_d_2_s_p_int_6, __f2dace_SA_cell_blk_d_0_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_0_s_verts_p_patch_5, __f2dace_SA_cell_blk_d_1_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_1_s_verts_p_patch_5, __f2dace_SA_cell_idx_d_0_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_0_s_verts_p_patch_5, __f2dace_SA_cell_idx_d_1_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_1_s_verts_p_patch_5, __f2dace_SA_cell_idx_d_2_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_2_s_verts_p_patch_5, __f2dace_SA_cells_aw_verts_d_0_s_p_int_6, __f2dace_SA_cells_aw_verts_d_1_s_p_int_6, __f2dace_SA_cells_aw_verts_d_2_s_p_int_6, __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8, __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_0_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_1_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_2_s_p_metrics_8, __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_full_e_d_2_s_p_metrics_8, __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_half_d_2_s_p_metrics_8, __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_3_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9, __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8, __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8, __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8, __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8, __f2dace_SA_e_bln_c_s_d_0_s_p_int_6, __f2dace_SA_e_bln_c_s_d_1_s_p_int_6, __f2dace_SA_e_bln_c_s_d_2_s_p_int_6, __f2dace_SA_edge_blk_d_0_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_0_s_verts_p_patch_5, __f2dace_SA_edge_blk_d_1_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_1_s_verts_p_patch_5, __f2dace_SA_edge_blk_d_2_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_2_s_verts_p_patch_5, __f2dace_SA_edge_idx_d_0_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_0_s_verts_p_patch_5, __f2dace_SA_edge_idx_d_1_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_1_s_verts_p_patch_5, __f2dace_SA_edge_idx_d_2_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_2_s_verts_p_patch_5, __f2dace_SA_f_e_d_0_s_edges_p_patch_4, __f2dace_SA_f_e_d_1_s_edges_p_patch_4, __f2dace_SA_fn_e_d_0_s_edges_p_patch_4, __f2dace_SA_ft_e_d_0_s_edges_p_patch_4, __f2dace_SA_geofac_grdiv_d_0_s_p_int_6, __f2dace_SA_geofac_grdiv_d_1_s_p_int_6, __f2dace_SA_geofac_grdiv_d_2_s_p_int_6, __f2dace_SA_geofac_n2s_d_0_s_p_int_6, __f2dace_SA_geofac_n2s_d_1_s_p_int_6, __f2dace_SA_geofac_n2s_d_2_s_p_int_6, __f2dace_SA_geofac_rot_d_0_s_p_int_6, __f2dace_SA_geofac_rot_d_1_s_p_int_6, __f2dace_SA_geofac_rot_d_2_s_p_int_6, __f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4, __f2dace_SA_inv_dual_edge_length_d_1_s_edges_p_patch_4, __f2dace_SA_inv_primal_edge_length_d_0_s_edges_p_patch_4, __f2dace_SA_inv_primal_edge_length_d_1_s_edges_p_patch_4, __f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2, __f2dace_SA_owner_mask_d_0_s_decomp_info_cells_p_patch_3, __f2dace_SA_quad_blk_d_0_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_1_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_2_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_0_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_1_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_2_s_edges_p_patch_4, __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6, __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6, __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6, __f2dace_SA_tangent_orientation_d_0_s_edges_p_patch_4, __f2dace_SA_tangent_orientation_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_2_s_edges_p_patch_4, __f2dace_SA_vn_d_0_s_p_prog_7, __f2dace_SA_vn_d_2_s_p_prog_7, __f2dace_SA_vn_ie_d_0_s_p_diag_9, __f2dace_SA_vn_ie_d_2_s_p_diag_9, __f2dace_SA_vt_d_0_s_p_diag_9, __f2dace_SA_vt_d_2_s_p_diag_9, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SA_w_concorr_c_d_2_s_p_diag_9, __f2dace_SA_w_d_0_s_p_prog_7, __f2dace_SA_w_d_2_s_p_prog_7, __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8, __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8, __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8, __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8, __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8, __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8, __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8, __f2dace_SOA_area_d_0_s_cells_p_patch_2, __f2dace_SOA_area_d_1_s_cells_p_patch_2, __f2dace_SOA_area_edge_d_0_s_edges_p_patch_4, __f2dace_SOA_area_edge_d_1_s_edges_p_patch_4, __f2dace_SOA_c_lin_e_d_0_s_p_int_6, __f2dace_SOA_c_lin_e_d_1_s_p_int_6, __f2dace_SOA_c_lin_e_d_2_s_p_int_6, __f2dace_SOA_cell_idx_d_0_s_edges_p_patch_4, __f2dace_SOA_cell_idx_d_0_s_verts_p_patch_5, __f2dace_SOA_cell_idx_d_1_s_edges_p_patch_4, __f2dace_SOA_cell_idx_d_1_s_verts_p_patch_5, __f2dace_SOA_cell_idx_d_2_s_edges_p_patch_4, __f2dace_SOA_cell_idx_d_2_s_verts_p_patch_5, __f2dace_SOA_cells_aw_verts_d_0_s_p_int_6, __f2dace_SOA_cells_aw_verts_d_1_s_p_int_6, __f2dace_SOA_cells_aw_verts_d_2_s_p_int_6, __f2dace_SOA_coeff1_dwdz_d_0_s_p_metrics_8, __f2dace_SOA_coeff1_dwdz_d_1_s_p_metrics_8, __f2dace_SOA_coeff1_dwdz_d_2_s_p_metrics_8, __f2dace_SOA_coeff2_dwdz_d_0_s_p_metrics_8, __f2dace_SOA_coeff2_dwdz_d_1_s_p_metrics_8, __f2dace_SOA_coeff2_dwdz_d_2_s_p_metrics_8, __f2dace_SOA_coeff_gradekin_d_0_s_p_metrics_8, __f2dace_SOA_coeff_gradekin_d_1_s_p_metrics_8, __f2dace_SOA_coeff_gradekin_d_2_s_p_metrics_8, __f2dace_SOA_ddqz_z_full_e_d_0_s_p_metrics_8, __f2dace_SOA_ddqz_z_full_e_d_1_s_p_metrics_8, __f2dace_SOA_ddqz_z_full_e_d_2_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_1_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_2_s_p_metrics_8, __f2dace_SOA_ddt_vn_apc_pc_d_0_s_p_diag_9, __f2dace_SOA_ddt_vn_apc_pc_d_1_s_p_diag_9, __f2dace_SOA_ddt_vn_apc_pc_d_2_s_p_diag_9, __f2dace_SOA_ddt_vn_apc_pc_d_3_s_p_diag_9, __f2dace_SOA_ddt_w_adv_pc_d_0_s_p_diag_9, __f2dace_SOA_ddt_w_adv_pc_d_1_s_p_diag_9, __f2dace_SOA_ddt_w_adv_pc_d_2_s_p_diag_9, __f2dace_SOA_ddt_w_adv_pc_d_3_s_p_diag_9, __f2dace_SOA_ddxn_z_full_d_0_s_p_metrics_8, __f2dace_SOA_ddxn_z_full_d_1_s_p_metrics_8, __f2dace_SOA_ddxn_z_full_d_2_s_p_metrics_8, __f2dace_SOA_ddxt_z_full_d_0_s_p_metrics_8, __f2dace_SOA_ddxt_z_full_d_1_s_p_metrics_8, __f2dace_SOA_ddxt_z_full_d_2_s_p_metrics_8, __f2dace_SOA_e_bln_c_s_d_0_s_p_int_6, __f2dace_SOA_e_bln_c_s_d_1_s_p_int_6, __f2dace_SOA_e_bln_c_s_d_2_s_p_int_6, __f2dace_SOA_edge_blk_d_0_s_cells_p_patch_2, __f2dace_SOA_edge_blk_d_0_s_verts_p_patch_5, __f2dace_SOA_edge_blk_d_1_s_cells_p_patch_2, __f2dace_SOA_edge_blk_d_1_s_verts_p_patch_5, __f2dace_SOA_edge_blk_d_2_s_cells_p_patch_2, __f2dace_SOA_edge_blk_d_2_s_verts_p_patch_5, __f2dace_SOA_edge_idx_d_0_s_cells_p_patch_2, __f2dace_SOA_edge_idx_d_0_s_verts_p_patch_5, __f2dace_SOA_edge_idx_d_1_s_cells_p_patch_2, __f2dace_SOA_edge_idx_d_1_s_verts_p_patch_5, __f2dace_SOA_edge_idx_d_2_s_cells_p_patch_2, __f2dace_SOA_edge_idx_d_2_s_verts_p_patch_5, __f2dace_SOA_end_block_d_0_s_cells_p_patch_2, __f2dace_SOA_end_block_d_0_s_edges_p_patch_4, __f2dace_SOA_end_block_d_0_s_verts_p_patch_5, __f2dace_SOA_end_index_d_0_s_cells_p_patch_2, __f2dace_SOA_end_index_d_0_s_edges_p_patch_4, __f2dace_SOA_end_index_d_0_s_verts_p_patch_5, __f2dace_SOA_f_e_d_0_s_edges_p_patch_4, __f2dace_SOA_f_e_d_1_s_edges_p_patch_4, __f2dace_SOA_geofac_grdiv_d_0_s_p_int_6, __f2dace_SOA_geofac_grdiv_d_1_s_p_int_6, __f2dace_SOA_geofac_grdiv_d_2_s_p_int_6, __f2dace_SOA_geofac_n2s_d_0_s_p_int_6, __f2dace_SOA_geofac_n2s_d_1_s_p_int_6, __f2dace_SOA_geofac_n2s_d_2_s_p_int_6, __f2dace_SOA_geofac_rot_d_0_s_p_int_6, __f2dace_SOA_geofac_rot_d_1_s_p_int_6, __f2dace_SOA_geofac_rot_d_2_s_p_int_6, __f2dace_SOA_inv_dual_edge_length_d_0_s_edges_p_patch_4, __f2dace_SOA_inv_dual_edge_length_d_1_s_edges_p_patch_4, __f2dace_SOA_inv_primal_edge_length_d_0_s_edges_p_patch_4, __f2dace_SOA_inv_primal_edge_length_d_1_s_edges_p_patch_4, __f2dace_SOA_neighbor_idx_d_0_s_cells_p_patch_2, __f2dace_SOA_neighbor_idx_d_1_s_cells_p_patch_2, __f2dace_SOA_neighbor_idx_d_2_s_cells_p_patch_2, __f2dace_SOA_owner_mask_d_0_s_decomp_info_cells_p_patch_3, __f2dace_SOA_owner_mask_d_1_s_decomp_info_cells_p_patch_3, __f2dace_SOA_quad_blk_d_0_s_edges_p_patch_4, __f2dace_SOA_quad_blk_d_1_s_edges_p_patch_4, __f2dace_SOA_quad_blk_d_2_s_edges_p_patch_4, __f2dace_SOA_quad_idx_d_0_s_edges_p_patch_4, __f2dace_SOA_quad_idx_d_1_s_edges_p_patch_4, __f2dace_SOA_quad_idx_d_2_s_edges_p_patch_4, __f2dace_SOA_rbf_vec_coeff_e_d_0_s_p_int_6, __f2dace_SOA_rbf_vec_coeff_e_d_1_s_p_int_6, __f2dace_SOA_rbf_vec_coeff_e_d_2_s_p_int_6, __f2dace_SOA_start_block_d_0_s_cells_p_patch_2, __f2dace_SOA_start_block_d_0_s_edges_p_patch_4, __f2dace_SOA_start_block_d_0_s_verts_p_patch_5, __f2dace_SOA_start_index_d_0_s_cells_p_patch_2, __f2dace_SOA_start_index_d_0_s_edges_p_patch_4, __f2dace_SOA_start_index_d_0_s_verts_p_patch_5, __f2dace_SOA_tangent_orientation_d_0_s_edges_p_patch_4, __f2dace_SOA_tangent_orientation_d_1_s_edges_p_patch_4, __f2dace_SOA_vertex_idx_d_0_s_edges_p_patch_4, __f2dace_SOA_vertex_idx_d_1_s_edges_p_patch_4, __f2dace_SOA_vertex_idx_d_2_s_edges_p_patch_4, __f2dace_SOA_vn_d_0_s_p_prog_7, __f2dace_SOA_vn_d_1_s_p_prog_7, __f2dace_SOA_vn_d_2_s_p_prog_7, __f2dace_SOA_vn_ie_d_0_s_p_diag_9, __f2dace_SOA_vn_ie_d_1_s_p_diag_9, __f2dace_SOA_vn_ie_d_2_s_p_diag_9, __f2dace_SOA_vt_d_0_s_p_diag_9, __f2dace_SOA_vt_d_1_s_p_diag_9, __f2dace_SOA_vt_d_2_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_1_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_2_s_p_diag_9, __f2dace_SOA_w_d_0_s_p_prog_7, __f2dace_SOA_w_d_1_s_p_prog_7, __f2dace_SOA_w_d_2_s_p_prog_7, __f2dace_SOA_wgtfac_c_d_0_s_p_metrics_8, __f2dace_SOA_wgtfac_c_d_1_s_p_metrics_8, __f2dace_SOA_wgtfac_c_d_2_s_p_metrics_8, __f2dace_SOA_wgtfac_e_d_0_s_p_metrics_8, __f2dace_SOA_wgtfac_e_d_1_s_p_metrics_8, __f2dace_SOA_wgtfac_e_d_2_s_p_metrics_8, __f2dace_SOA_wgtfacq_e_d_0_s_p_metrics_8, __f2dace_SOA_wgtfacq_e_d_1_s_p_metrics_8, __f2dace_SOA_wgtfacq_e_d_2_s_p_metrics_8, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_10, tmp_struct_symbol_11, tmp_struct_symbol_12, tmp_struct_symbol_13, tmp_struct_symbol_14, tmp_struct_symbol_2, tmp_struct_symbol_3, tmp_struct_symbol_4, tmp_struct_symbol_5, tmp_struct_symbol_6, tmp_struct_symbol_7, tmp_struct_symbol_8, tmp_struct_symbol_9);
    __state->__0_bitwidth_check_done = 0;
    __state->__0_bitwidth_scalar = -1;
    __state->__0_nblk_lowering_done = 0;
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_w_con_c, (91 * tmp_struct_symbol_1) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_cfl_clipping, (91 * tmp_struct_symbol_14) * sizeof(uint8_t)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_v_grad_w, (((90 * tmp_struct_symbol_4) * (tmp_struct_symbol_5 - 1)) + (90 * tmp_struct_symbol_4)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_zeta, (((90 * tmp_struct_symbol_8) * (tmp_struct_symbol_9 - 1)) + (90 * tmp_struct_symbol_8)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_maxvcfl_arr, (((88 * tmp_struct_symbol_4) * (tmp_struct_symbol_11 - 1)) + (88 * tmp_struct_symbol_4)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMemset(__state->__0_gpu_maxvcfl_arr, 0, (((88 * tmp_struct_symbol_4) * (tmp_struct_symbol_11 - 1)) + (88 * tmp_struct_symbol_4)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_ekinh, (((90 * tmp_struct_symbol_10) * (tmp_struct_symbol_11 - 1)) + (90 * tmp_struct_symbol_10)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_w_concorr_mc, (90 * tmp_struct_symbol_0) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_levelmask, 90 * sizeof(uint8_t)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_w_v, (((91 * tmp_struct_symbol_6) * (tmp_struct_symbol_7 - 1)) + (91 * tmp_struct_symbol_6)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_levmask, (90 * tmp_struct_symbol_13) * sizeof(uint8_t)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_z_w_con_c_full, (((90 * tmp_struct_symbol_2) * (tmp_struct_symbol_3 - 1)) + (90 * tmp_struct_symbol_2)) * sizeof(dace::float16)));
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_gpu_vcflmax, tmp_struct_symbol_12 * sizeof(dace::float16)));
